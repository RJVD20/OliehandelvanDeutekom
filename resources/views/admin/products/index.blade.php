...
<form method="GET" action="{{ route('admin.products.index') }}" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <select name="brand" class="text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-green-500" onchange="this.form.submit()">
            <option value="">Alle actieve merken</option>
    ...
    <div class="mt-3 flex flex-wrap items-center gap-3">
        ...
        @if(request()->hasAny(['search','category_id','type','brand','sort']))
